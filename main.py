...
photologo = 'https://postimg.cc/ns1X0VPS' #https://envs.sh/GV0.jpg
photo = 'https://i.postimg.cc/7LkVbrjm/yt.jpg' #https://envs.sh/GVi.jpg
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/erpurchasebot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/erpurchasebot"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/erpurchasebot"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"┏━━━━━━━━━━━━━━━━━━━━━━━┓\n"
        f"             🧠 𝐌𝐚𝐝𝐞 𝐁𝐲: [𝕰𝖓𝖌𝖎𝖓𝖊𝖊𝖗𝖘 𝕭𝖆𝖇𝖚™👨🏻‍💻](https://t.me/erpurchasebot)\n"
        f"┗━━━━━━━━━━━━━━━━━━━━━━━┛"
        )
    )
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[𝕰𝖓𝖌𝖎𝖓𝖊𝖊𝖗𝖘 𝕭𝖆𝖇𝖚™👨🏻‍💻](https://t.me/erpurchasebot)'
    else:
        CR = raw_text3
    ...
    try:
        ...
        'X-CDN-Tag': 'empty'
            ...
            try:
                ...
                cyt = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\n**🎥 Title : {name1}** \n\n**📚COURSE : {b_name}** [{app}]\n\n**🔗 𝐕𝐢𝐝𝐞𝐨 𝐥𝐢𝐧𝐤 - <a href="{url}">__**Click Here to Watch Video**__\n\n**📥 Extracted By :** {CR}'
                ...
                if "drive" in url:
                    ...
                    try:
                        await bot.send_photo(chat_id=m.chat.id, photo=photo, caption=cyt, parse_mode="HTML")
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(1)    
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝕰𝖓𝖌𝖎𝖓𝖊𝖊𝖗𝖘 𝕭𝖆𝖇𝖚™👨🏻‍💻](https://t.me/erpurchasebot)"
    ...
    try:
        ...
        'X-CDN-Tag': 'empty'
            ...
            if "jw-prod" in url:
               ...
               cmd = f'yt-dlp --add-header "referer:https://web.classplusapp.com/" --add-header "x-cdn-tag:empty" -f "{ytf}" "{url}" -o "{name}.mp4"'
            #outu.be" in url:
                #cmd = f'yt-dlp --cookies yelif "youtube.com" in url or "youtube_cookies.txt -f "{ytf}" "{url}" -o "{name}".mp4'
            else:
                cmd = f'yt-dlp -f "{ytf}" "{url}" -o "{name}.mp4"'

            try:
                cc = f'🎥𝐓𝐢𝐭𝐥𝐞 » {name} [{res}].mp4\n🔗𝐋𝐢𝐧𝐤 » <a href="{link}">__**CLICK HERE**__</a>\n\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 » `UG 𝐁𝐎𝐓𝐒`'
                cc1 = f'📕𝐓𝐢𝐭𝐥𝐞 » {name}\n🔗𝐋𝐢𝐧𝐤 » <a href="{link}">__**CLICK HERE**__</a>\n\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 » `UG 𝐁𝐎𝐓𝐒`'
                ...
                if "drive" in url:
                    ...
                    cmd = f'yt-dlp -f "{ytf}" "{url}" -o "{name}.pdf"'
